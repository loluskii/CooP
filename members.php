...
<?php 
    ...
    require_once('registration/auth.php');
    ?> 
    <!DOCTYPE html>  
...
<div class="header__btn-area">
<a href="logout.php" class="header__btn-area__log-in">
Log Out
</a>
...
<h5>Welcome <?php echo $_SESSION['SESS_NAME'] ; ?> </h5> 
<center>
<a href="#" class="btn btn-info" role="button">Properties</a>
<a href="#" class="btn btn-info" role="button">ROI Calculator</a>
<a href="#" class="btn btn-info" role="button">Invest Now</a>
</center>
  </div>
</div>
