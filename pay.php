...
<a><img src="img/logo.png" class="header__logo"></a>
</div>
</div>
<div class="col-xs-8 visible-xs">
<div class="header__btn-area">
<a href="login2.html" class="btn">
Log in
</a>
...
<div class="header__btn-area">
<a href="login2.html" class="header__btn-area__log-in">
Log in
</a>
...
-->
    ...
    <div class="row">
      <h4>Membership Registration Fee</h4>
      <div id="paystackEmbedContainer"></div>	

<input type="hidden" name="usermail" id="usermail" value="<?php 	echo $_SESSION['USEREMAIL'] ;?>">
<input type="hidden" name="userphone" id="userphone" value="<?php 	echo $_SESSION['USERPHONE'] ;?>">
...
window.onload = function () {
  ...
  PaystackPop.setup({
   ...
   key: 'pk_test_50e6c8119e5e58cbe4539f852ff79a2772a893eb',
   ...
   callback: function(response){
	...
	var url = "registration/saveuser.php";
